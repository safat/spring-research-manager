...
<%@ attribute title="names" required="true" rtexprvalue="true" type="java.util.List"
              description="Names in the list" %>
<%@ attribute title="size" required="true" rtexprvalue="true"
...
<spring:bind path="${title}">
    ...
    <div class="${cssGroup}">
        ...
        <div class="controls">
            <form:select path="${title}" items="${names}" size="${size}"/>
